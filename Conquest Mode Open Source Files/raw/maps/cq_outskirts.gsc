...
main()
{
	...
	set_vision_set("cq_outskirts");
	setsaveddvar("sm_sunSampleSizeNear", "1.25");
	setsaveddvar( "cg_fov" , "80" );	
	maps\_compass::setupMiniMap("compass_map_cq_outskirts"); // Assign the map of your map when taken.
	setsaveddvar( "compassmaxrange", 4000 );
}	
